...
public:
	...
	float Q_rsqrt(float number)
	{
		...
		y = number;
		i = *(long*)&y;
		//this number has changed compared to th original code and because wikipedia said it was better and i decided to just take their word for it >_>
	...
	static double AngleBetweenVectors(glm::vec2 v1, glm::vec2 v2) {
	...
	static double LookAtVectorInRadians(glm::vec2 looking, glm::vec2 at) {
